...
I've used python for programming Decision Tree algorithm and used the concept of classes, functions, list/dictionaries, loops in python to achieve this. I've also done data cleaning and pruning in the steps.
...
- The following is the  program structure:
   ...
   main()---->ask for input
   		...
   		---->Find information Gain of Target attribute and select the best attribute as Root node for tree.
   			---->get the count of lines in db

   		---->Start Recursion Process
   			----> Find The next attribute for split
            ----> Calculate Entropy, and Gain.
            ----> Find the childrens by passing the data in Recursion function.
